      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href=""><img src="../../assets/style/images/logo.png" alt="LP" width="30px"> BCS</a>
          </div>
          ...
          <ul class="sidebar-menu">
              ...
              <li <?php if ($title == "Booking") { echo 'class="active"'; } ?>><a class="nav-link" href="../administrasi/tampilData.php"><i class="fas fa-bold"></i><span>Booking</span></a></li>
              <li <?php if ($title == "Cetak Kartu") { echo 'class="active"'; } ?>><a class="nav-link" href="../cetak/tampilData.php"><i class="fas fa-print"></i></i> <span>Cetak Kartu</span></a></li>
              <li <?php if ($title == "Booking report") { echo 'class="active"'; } ?>><a class="nav-link" href="../cetak/tampilData.php"><i class="fas fa-file"></i></i></i> <span>Booking report</span></a></li>
