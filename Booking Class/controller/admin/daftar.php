<?php 
	...
	if (isset($_POST['tambahDataSiswa'])) {
		$nim 				= mysqli_real_escape_varchar($conn, $_POST['nim']); 
		$nama 				= mysqli_real_escape_varchar($conn, $_POST['nama']); 
		$kelas				= mysqli_real_escape_varchar($conn, $_POST['kelas']); 
		$prodi				= mysqli_real_escape_varchar($conn, $_POST['prodi']); 
		$angkatan			= mysqli_real_escape_varchar($conn, $_POST['nama_lengkap']); 
		$jenis_kelamin		= mysqli_real_escape_varchar($conn, $_POST['jenis_kelamin']); 
	...
	if (isset($_POST['loginDataPeserta'])) {
		...
		$query = mysqli_query($conn, "SELECT * FROM identitas_siswa WHERE nim = '$nim' AND nim = '$nim'") or die(mysqli_error($conn));
